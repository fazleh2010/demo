...
public class LangPairManager {
    ...
    public LangPairManager(String language, String alpahbetPair, Properties props, Partition<String> partition, Integer numericalValueOfPair) throws Exception {
