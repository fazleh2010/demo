 ...
 */
public class LangPairFilesGen {

    private TermLists myTerminology = null;
    ...
    public LangPairFilesGen(LanguageManager languageInfo, TermLists myTerminology) throws Exception {
